...
def Bi-LSTM_Traffic_classification(root_normalized_dir,net_parameters,model_params):
    ...
    for path in os.listdir(root_normalized_dir):
        ...
        model = Bi-LSTM_build_model(model_params)
    ...
    model.save(save_model_weights_dir + 'model_architecture_bilstm.h5')
    saved_models.append('model_architecture_bilstm.h5') 
    # save model weights
    model.save_weights(save_model_weights_dir + 'model_weights_bilstm.h5')      
    saved_weights.append('model_weights_bilstm.h5')
